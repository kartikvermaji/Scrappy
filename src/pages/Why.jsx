    ...
    <section className="bg-black text-white py-16 px-6 md:px-16 md:mt-10 pb-20">
      <div className="flex flex-col-reverse md:flex-row items-start justify-between gap-10">
        ...
        <div className="relative w-full md:w-1/2 flex flex-col justify-start items-center">
          ...
          >
            <h2 className="text-3xl lg:text-5xl font-bold mb-4">Why  Scrap Store </h2>
            ...
            <button
             onClick={handleClick}
             className="mt-6 flex items-center group border border-black px-6 py-2 rounded-full text-sm lg:text-base font-light hover:bg-black hover:text-white transition-all duration-200">
              Get Started
