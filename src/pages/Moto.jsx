...
const Moto = () => {
  ...
  return (
    <div className='flex justify-center items-center  bg-slate-50 h-[70vh] pb-[10vh]  md:h-[60vh] lg:h-[70vh] text-black'>
       <motion.div 
      ...
      className="flex justify-center lg:ml-24 items-center flex-col md:flex-row mt-[-4vh] md:space-x-20 lg:space-x-44  lg:mt-10 md:mt-0 w-[80vw]  ">
        ...
        <p className="font-semibold lg:text-lg lg:font-extralight  md:text-sm text-sm text-center ml-[-4vw] w-[90vw] md:text-left  md:w-[44vw] lg:w-[34vw] mt-5 md:mt-10 lg:mt-0">
